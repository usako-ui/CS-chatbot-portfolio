 ...
 *
 * 【選び方】AIの4通りの振る舞いを一通り試せるように並べている。
 *   - FAQで完結する質問（送料・在庫）
 *   - FAQ案内のうえで担当者を提案する質問（返品・交換の手続き）
 *   - FAQに根拠が無く担当者へ回す質問（個別の請求調査）
 *   - クレーム（謝罪を添えて担当者へ回す）
 * どれか1種類に偏らせると「AIが答えるだけのボット」に見えてしまい、
 * 引き継ぎ判定という本体の機能が伝わらない。
 *
 * 送信まではしない。体験者自身のAPIキーを消費するため、
 * 押し間違いで勝手にリクエストが飛ばないようにしている。
 */
const SAMPLE_QUESTIONS = [
  ...
  { label: '不満を伝える', text: '対応が遅すぎます。もう二度と買いません。' },
];
